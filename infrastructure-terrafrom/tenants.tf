module "iam_tenants_worker_groups" {
  ...
  worker_group_role_name  = lookup(var.tenants[each.key], "worker_group_role_name", local.tenants_defaults["worker_group_role_name"])
...
module "iam_tenants_kaniko" {
  ...
  kaniko_role_name  = lookup(var.tenants[each.key], "kaniko_role_name", local.tenants_defaults["kaniko_role_name"])
